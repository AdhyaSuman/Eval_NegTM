...
from octis.models.contextualized_topic_models_neg2.networks.inference_network import CombinedInferenceNetwork, ContextualInferenceNetwork
...
class DecoderNetwork(nn.Module):
    ...
    def __init__(self, input_size, bert_size, infnet, n_components=10, model_type='prodLDA',
                 ...
                 learn_priors=True, topic_prior_mean=0.0, topic_prior_variance=None, topic_perturb=1):
        """
    ...
    def forward(self, x, x_bert):
        ...
        # print("Posterior Mu = ", posterior_mu)
