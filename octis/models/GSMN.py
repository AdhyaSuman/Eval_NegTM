...
class GSMN(AbstractModel):

    def __init__(self, num_topics=10, num_epochs=100, batch_size=512,
                 use_partitions=False, use_validation=False,
                 num_samples=10,
                 neg_dec=True, topic_perturb=None, tloss_weight=None):
    ...
    def train_model(self, dataset, hyperparameters=None, top_words=10):
        ...
        print("topic_perturb={}, tloss_weight={}".format(self.hyperparameters['topic_perturb'], self.hyperparameters['tloss_weight']))
