...
class AVITM(AbstractModel):
    ...
    def __init__(self, num_topics=10, model_type='prodLDA', activation='softplus',
                 ...
                 use_partitions=True, use_validation=False, topic_perturb=1, tloss_weight=1.0, neg_method=False):
        """
    ...
    def train_model(self, dataset, hyperparameters=None, top_words=10):
        ...
        if self.use_partitions and self.use_validation:
            ...
            self.vocab = dataset.get_vocabulary()
            x_train, x_test, input_size = self.preprocess(self.vocab,
                                                          data_corpus_train,
    ...
    def set_params(self, hyperparameters):
        ...
        self.hyperparameters['topic_perturb'] = \
            int(hyperparameters.get('topic_perturb', self.hyperparameters['topic_perturb']))
        
        self.hyperparameters['tloss_weight'] = \
            float(hyperparameters.get('tloss_weight', self.hyperparameters['tloss_weight']))
